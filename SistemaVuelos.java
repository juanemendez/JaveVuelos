...
public class SistemaVuelos implements ISistemaViajes{
	...
	public VueloEspecifico buscarEspecifico(long codigoEspecifico){
		...
		Set<Long> keys=listaAerolineas.keySet();
		for(Long k:keys){
			vueloEspecifico=this.listaAerolineas.get(k).buscarVueloEspecifico(codigoEspecifico);
		}
		return vueloEspecifico;
	}
	/**
	...
	public void agregarVueloEspecificoNacional(long codigoAerolinea, long codigoVueloPlaneado, LocalDate fecha,
			String tipoAvion, int capacidad,long tarifa, int iva) {
		Aerolinea aerolinea=buscarAerolinea(codigoAerolinea);
		aerolinea.agregarVueloEspecificoNacional(codigoVueloPlaneado,fecha,tipoAvion,capacidad,tarifa,iva);
		// TODO Auto-generated method stub
		
	}
	@Override
	public void agregarVueloEspecificoInternacional(long codigoAerolinea, long codigoVueloPlaneado, LocalDate fecha,
			String tipoAvion, int capacidad,long tarifa, long impuesto) {
		Aerolinea aerolinea=buscarAerolinea(codigoAerolinea);
		aerolinea.agregarVueloEspecificoInternacional(codigoVueloPlaneado,fecha,tipoAvion,capacidad,tarifa,impuesto);
		// TODO Auto-generated method stub
	...
	public void agregarVueloEspecificoCharter(long codigoAerolinea,long codigoVueloPlaneado, LocalDate fecha,String tipoAvion, int capacidad,long tarifa, String nombreComprador){
		Aerolinea aerolinea = buscarAerolinea(codigoAerolinea);
		aerolinea.agregarVueloEspecificoCharter(codigoVueloPlaneado, fecha, tipoAvion, capacidad, tarifa, nombreComprador);
