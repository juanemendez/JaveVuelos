...
public class Aerolinea {
	 ...
	 * @param tarifa
	 */
	public void agregarVueloEspecificoNacional(long codigoVueloPlaneado,LocalDate fecha, String tipoAvion, int capacidad, long tarifa,int iva){
		VueloPlaneado vueloPlaneado=buscarVueloPlaneado(codigoVueloPlaneado);
		vueloPlaneado.agregarVueloEspecificoNacional(fecha,tipoAvion,capacidad,tarifa,iva);
	}
	
	public void agregarVueloEspecificoInternacional(long codigoVueloPlaneado,LocalDate fecha, String tipoAvion, int capacidad, long tarifa,long impuesto){
		VueloPlaneado vueloPlaneado=buscarVueloPlaneado(codigoVueloPlaneado);
		vueloPlaneado.agregarVueloEspecificoInternacional(fecha,tipoAvion,capacidad,tarifa,impuesto);
	}
	/**
	...
	public void agregarVueloEspecificoCharter(long codigoVueloPlaneado, LocalDate fecha,String tipoAvion, int capacidad,long tarifa, String nombreComprador){
		VueloPlaneado vueloPlaneado = buscarVueloPlaneado(codigoVueloPlaneado);
		vueloPlaneado.agregarVueloEspecificoCharter(fecha, tipoAvion, capacidad, tarifa, nombreComprador);
	}
}
