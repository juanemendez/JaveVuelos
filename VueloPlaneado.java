...
public class VueloPlaneado {
	 ...
	 * @param tarifa
	 */
	public void agregarVueloEspecificoNacional(LocalDate fecha, String tipoAvion, int capacidad, long tarifa,int iva){
		VueloEspecifico vueloEspecifico=new VueloEspecificoNacional(fecha,tipoAvion,capacidad,this,tarifa,iva);
	...
	public void agregarVueloEspecificoInternacional(LocalDate fecha, String tipoAvion, int capacidad, long tarifa,long impuesto){
		VueloEspecifico vueloEspecifico=new VueloEspecificoInternacional(fecha,tipoAvion,capacidad,this,tarifa,impuesto);
		this.listaVuelosEspecificos.add(vueloEspecifico);
		System.out.println("El vuelo especifico ha sido creado con el codigo "+vueloEspecifico.getCodigo());
	}
	
	public void agregarVueloEspecificoCharter(LocalDate fecha,String tipoAvion, int capacidad,long tarifa, String nombreComprador){
		VueloEspecifico vueloEspecifico = new VueloEspecificoCharter(fecha,tipoAvion,capacidad,this,tarifa,nombreComprador);
		this.getListaVuelosEspecificos().add(vueloEspecifico);
	}
}